  ...
  var RESOURCES = {
    projects: {
      ...
      fields: [
        ...
        { key: 'icon', label: 'Icon class', ph: 'fas fa-running', half: true, hint: 'Font Awesome class' },
        ...
        { key: 'gradient', label: 'Preview gradient (CSS)', ph: 'linear-gradient(135deg,#0a2e1f,#00e5a0,#0a3d2e)' },
        { key: 'imageUrl', label: 'Screenshot (optional, replaces icon in mockup)', type: 'image' },
